exports.profiles = function(grunt){
	return	{
			...
			'test' : {
				apiproxy : 'weather-test-apilab-oct-pd',
					org : 'tcs-devjam-phx', // replace with organization
					env : 'test',     // replace with environment
					url_mgmt : 'https://enterprise.apigee.com',  // for cloud environments, leave as is
